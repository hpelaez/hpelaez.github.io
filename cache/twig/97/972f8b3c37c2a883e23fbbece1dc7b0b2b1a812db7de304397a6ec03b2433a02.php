...
class __TwigTemplate_0f99bec0a6c34ba6815755a5957b0aa4a62830c47d36fde38155006f930fa4b0 extends \Twig\Template
{
        ...
        try {
            ...
            foreach ($context['_seq'] as $context["index"] => $context["field"]) {
                ...
                if (((null === ($context["input"] ?? null)) || (($context["input"] ?? null) == true))) {
                    ...
                    // line 7
                    echo twig_escape_filter($this->env, (($context["scope"] ?? null) . ((($this->getAttribute($context["field"], "name", [], "any", true, true) &&  !(null === $this->getAttribute($context["field"], "name", [])))) ? ($this->getAttribute($context["field"], "name", [])) : ($context["index"]))), "html", null, true);
                    echo ": ";
                    echo twig_escape_filter($this->env, ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->stringFunc(((twig_test_iterable(($context["value"] ?? null))) ? (twig_jsonencode_filter(($context["value"] ?? null))) : (twig_escape_filter($this->env, ($context["value"] ?? null), "yaml")))) . "
"), "html", null, true);
                } else {
                    // line 9
...
{%- endautoescape %}", "forms/default/data.txt.twig", "/Users/hpelaez/Workspace/project-mozart/user/plugins/form/templates/forms/default/data.txt.twig");
    }
}
