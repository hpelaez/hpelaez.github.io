...
class __TwigTemplate_c8b4d1d4d95fe5816a54e9b6dd39bb727869b5d749aa589d644ed0ff73bbf32a extends \Twig\Template
{
...
($context["field"] ?? null), "type", []) == "select")) {
            ...
            // line 30
            echo "                                ";
            echo nl2br(twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->stringFunc($this->getAttribute(($context["form"] ?? null), "value", [0 => (($context["scope"] ?? null) . $this->getAttribute(($context["field"] ?? null), "name", []))], "method"))));
            echo "
                            ";
        }
        // line 32
...
", "forms/default/data.html.twig", "/Users/hpelaez/Workspace/project-mozart/user/plugins/form/templates/forms/default/data.html.twig");
    }
}
